...
var _foodViewJs = require("./views/foodView.js");
var _foodViewJsDefault = parcelHelpers.interopDefault(_foodViewJs);
...
const controlFoods = async function() {
    try {
        ...
        if (!id) return;
        (0, _foodViewJsDefault.default).renderSpinner();
        // 1) loading receipt
        await _modelJs.loadFood(id);
        // 2) rendering receipt
        (0, _foodViewJsDefault.default).render(_modelJs.state.foodNutrients);
    } catch (err) {
        (0, _foodViewJsDefault.default).renderError();
    }
};
...
const init = function() {
    (0, _foodViewJsDefault.default).addHandlerRender(controlFoods);
    (0, _searchViewJsDefault.default).addHandlerSearch(controlSearchResults);
    (0, _paginationViewJsDefault.default).addHandlerClick(controlPagination);
};
init();

},{"core-js/modules/es.regexp.flags.js":"gSXXb","core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./views/foodView.js":"8Ufhm","./views/searchView.js":"9OQAM","./views/resultView.js":"f70O5","./views/paginationView.js":"6z7bi","regenerator-runtime/runtime":"dXNgZ","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gSXXb":[function(require,module,exports) {
...
parcelHelpers.export(exports, "loadFood", ()=>loadFood);
...
const loadFood = async function(id) {
    try {
        const data = await (0, _helpersJs.getJSON)(`${(0, _configJs.API_URL)}food/${id}?nutrients=208&nutrients=203&nutrients=204&nutrients=205&nutrients=291&nutrients=269&nutrients=301&nutrients=303&nutrients=306&nutrients=307&nutrients=328&nutrients=606&nutrients=695&nutrients=601&api_key=zsAOsFaartSbBnTqdjd6pHwetQJCjnXIyrukejdd`);
...
const loadSearchResults = async function(query) {
    try {
        ...
        const data = await (0, _helpersJs.getJSON)(//   `${API_URL}foods/search?query=${query}&dataType=Foundation&api_key=zsAOsFaartSbBnTqdjd6pHwetQJCjnXIyrukejdd`
        `${(0, _configJs.API_URL)}foods/search?query=${query}&dataType=Foundation,Branded&pageSize=200&sortBy=dataType.keyword&sortOrder=desc&api_key=zsAOsFaartSbBnTqdjd6pHwetQJCjnXIyrukejdd`);
...
},{"regenerator-runtime":"dXNgZ","./config.js":"k5Hzs","./helpers.js":"hGI1E","../img/superfoods.png":"7la4X","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
...
},{"regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7la4X":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("hWUTQ") + "superfoods.1d9264a5.png" + "?" + Date.now();
...
},{}],"8Ufhm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class foodView extends (0, _viewJsDefault.default) {
    ...
    _generateMarkup() {
      ...
      <figure class="food__fig">
        <img src="${this._data.img}" alt="${this._data.title}" class="food__img" />
      ...
      <div class="recipe__details">
        <div class="recipe__info">
          ...
          <span class="recipe__info-data recipe__info-data--minutes">${this._data.publicationDate}</span>
        </div>
        <div class="recipe__info">
          <svg class="recipe__info-icon">
      ...
      <div class="recipe__ingredients">
        ...
        ${this._data.foodNutrients.map((nut)=>{
            return `
            <li class="recipe__ingredient">
              <svg class="recipe__icon">
                <use href="${0, _iconsSvgDefault.default}#icon-check"></use>
              </svg>
              <div class="recipe__quantity">${parseFloat(nut.amount).toFixed(2)}</div>
      ...
      <div id= "FoundationFoods " class="recipe__directions">
        ...
        fill sth
          <span class="recipe__publisher">${this._data.dataType}</span>. Please check out
...
},{"./View.js":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire04a4")
